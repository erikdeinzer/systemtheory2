 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Nov 28 11:27:33 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                s_read_write_win
...
extern void s_read_write_win_Start_wrapper(real_T *xD,
  SimStruct *S);
extern void s_read_write_win_Outputs_wrapper(const int32_T *TX,
  int16_T *RX,
  const real_T *xD,
  SimStruct *S);
extern void s_read_write_win_Update_wrapper(const int32_T *TX,
  int16_T *RX,
  real_T *xD,
  SimStruct *S);
extern void s_read_write_win_Terminate_wrapper(real_T *xD,
  SimStruct *S);
...
static void mdlStart(SimStruct *S)
{
  ...
  s_read_write_win_Start_wrapper(xD, S);
}
...
{
  const int32_T *TX = (int32_T *) ssGetInputPortRealSignal(S, 0);
  int16_T *RX = (int16_T *) ssGetOutputPortRealSignal(S, 0);
  const real_T *xD = ssGetDiscStates(S);
  s_read_write_win_Outputs_wrapper(TX, RX, xD, S);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  int16_T *RX = (int16_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *xD = ssGetDiscStates(S);
  s_read_write_win_Update_wrapper(TX, RX, xD, S);
}
...
{
  real_T *xD = ssGetDiscStates(S);
  s_read_write_win_Terminate_wrapper(xD, S);
}
